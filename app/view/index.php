...
-->
<link href="<?php echo CSS ?>/tooplate_style.css" rel="stylesheet" type="text/css" />
...
<div id="tooplate_header_wrapper">
    ...
    <div id="tooplate_header">
        ...
        <div id="site_title">
        	...
        	<h1><a href="#"><img src="<?php echo IMG ?>/tooplate_logo.png" alt="business template" /><span>Free HTML Template</span></a></h1>
...
<div id="tooplate_main">
    ...
    <div id="tooplate_content">
        ...
        <div class="image_wrapper fl_img"><img src="www/img/tooplate_image_01.jpg" alt="Image 01" /></div>
        ...
        <div class="col_w270 float_l">
			...
			<div class="image_wrapper2"><img src="<?php echo IMG ?>/tooplate_image_02.jpg" alt="Image 02" /></div>
        ...
        <div class="col_w270 float_r">
          ...
          <h2>Our Solutions</h2>
            ...
            <div class="image_wrapper2"><img src="<?php echo IMG ?>/tooplate_image_03.jpg" alt="Image 03" /></div>
